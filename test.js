...
it('correctly vaporizes something lowercase', () => {
    assert.equal(vaporwavely.vaporize('Tassoni, patrimonio italiano'), 'Ｔａｓｓｏｎｉ， ｐａｔｒｉｍｏｎｉｏ ｉｔａｌｉａｎｏ');
});

it('correctly vaporizes something mixed', () => {
    assert.equal(vaporwavely.vaporize('aesthetic nintendo'), 'ａｅｓｔｈｅｔｉｃ ｎｉｎｔｅｎｄｏ');
});
